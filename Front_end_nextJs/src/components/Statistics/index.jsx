      ...
      <div className={styles.containerStats}>
        ...
        <div className={`${styles.times} ${styles.infoSport}`}>
          ...
          <p className={styles.contentInfo}>
            <span className={styles.nbrInfo}>27h</span> 15min
          </p>
        </div>
        <div className={`${styles.distance} ${styles.infoSport}`}>
          <p className={styles.contentTitle}>Distance totale parcourue</p>
          <p className={styles.contentInfo}>
            <span className={styles.nbrInfo}>{distanceTotal}</span> km
          </p>
        </div>
        <div className={`${styles.nbrSessions} ${styles.infoSport}`}>
          <p className={styles.contentTitle}>Nombre de sessions</p>
          <p className={styles.contentInfo}>
            <span className={styles.nbrInfo}>{nbrSessions}</span> sessions
          </p>
        </div>
        ...
        <div className={`${styles.nbrDayRest} ${styles.infoSport}`}>
          <p className={styles.contentTitle}>Nombre de jours de repos</p>
          <p className={styles.contentInfo}>
